...
# write.table(preResCnvFinal, "/mnt/DATA5/tmp/kev/misc/20231202patient1LongSegPhylowgsCnv.txt", sep = "\t",
#             row.names = FALSE, col.names = TRUE, quote = FALSE)
# 
# write.table(ssmRes_filt, "/mnt/DATA5/tmp/kev/misc/20231202patient1LongSegPhylowgsSsm.txt", sep = "\t",
#             row.names = FALSE, col.names = TRUE, quote = FALSE)
