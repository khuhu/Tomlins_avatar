...
dbExistsTable(con, c("Zues_old_2", "rundb_pluginresult"))
dbExistsTable(con, c("Zues_old_2", "rundb_experimentanalysissettings"))

myTable <- dbReadTable(con, c("Zues_old_2","rundb_pluginresult"))
...
myTable2 <- dbReadTable(con, c("Zues_old_2","rundb_experimentanalysissettings"))
...
write.table(x = tableOfFun.filtered, file = "/home/kevhu/data/20170728ZuesOld.tsv", sep = "\t", row.names = FALSE)
