...
badSegs <- c("PR923_20_CCP 8 37699697 57080625", "PR924_20_CCP 8 30915961 57080732", "PR930_20_CCP 8 30915961 57080625",
             "PR924_20_CCP 8 30915961 57080625", "PR930_20_CCP 20 76763876 153774912")

allSeg_filt2 <- allSeg_filt2[-which(allSeg_filt2$str %in% badSegs), ]
...
preResCnv$ssms[which(preResCnv$ssm == "s6")] <- "s6,1,2"
preResCnv$ssms[which(preResCnv$ssm == "s2")] <- "s2,0,1"

preResCnvFinal <- preResCnv[, c("cnv", "a", "d", "ssms", "physical_cnvs")]


# write.table(preResCnvFinal, "/mnt/DATA5/tmp/kev/misc/20231202patient33LongSegPhylowgsCnv.txt", sep = "\t",
#             row.names = FALSE, col.names = TRUE, quote = FALSE)
# 
# write.table(ssmRes_filt, "/mnt/DATA5/tmp/kev/misc/20231202patient33LongSegPhylowgsSsm.txt", sep = "\t",
#             row.names = FALSE, col.names = TRUE, quote = FALSE)
