...
#load("/mnt/DATA4/kevhu/urineRNA/20180808urineCombinedModel.Robj")
#load("/mnt/DATA4/kevhu/urineRNA/20180808urineMipsModel.Robj")
#load("/mnt/DATA4/kevhu/urineRNA/20180808urineLogGeneModel.Robj")
#load("/mnt/DATA4/kevhu/urineRNA/20180808urinePsaModel.Robj")
#load("/mnt/DATA4/kevhu/urineRNA/2018024fullPSAmodel.Robj")
...
#load("/mnt/DATA4/kevhu/urineRNA/geneAS.Robj")
...
#a.2.log.30 <- cbind(ids.3,a.2.log[,genesAS])
...
#save(fiveFoldModel.log, file = "/mnt/DATA4/kevhu/urineRNA/20180808urineLogGeneModel.Robj")
...
### makign auc for testing
# full alpha = 0.1 and lambda = 0.02560442.
...
#save(fiveFoldModel.psa, file = "/mnt/DATA4/kevhu/urineRNA/20180808urinePsaModel.Robj")
...
#save(fiveFoldModel.combined, file = "/mnt/DATA4/kevhu/urineRNA/20180808urineCombinedModel.Robj")
...
#save(fiveFoldModel.mips, file = "/mnt/DATA4/kevhu/urineRNA/20180808urineMipsModel.Robj")
...
pdf(file = "/mnt/DATA4/kevhu/urineRNA/20180816urineVsGG3to5.pdf", onefile = TRUE, useDingbats = TRUE, pointsize = 18, width = 9)
plot(rocGraph.psa, col = alpha("red", alpha = 0.5), main = "ROCs: Training n=73; Testing n=36", ylab = "", xlab="", lty = 2, asp = FALSE)
par(new = TRUE)
