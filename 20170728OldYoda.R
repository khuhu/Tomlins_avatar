...
dbExistsTable(con, c("yoda_old_2", "rundb_pluginresult"))
dbExistsTable(con, c("yoda_old_2", "rundb_experimentanalysissettings"))

myTable <- dbReadTable(con, c("yoda_old_2","rundb_pluginresult"))
...
myTable2 <- dbReadTable(con, c("yoda_old_2","rundb_experimentanalysissettings"))
...
#reduced it from 88 -> 23



write.table(x = tableOfFun.filtered, file = "/home/kevhu/data/20170728OldYoda.tsv", row.names = FALSE,
            sep = "\t")
